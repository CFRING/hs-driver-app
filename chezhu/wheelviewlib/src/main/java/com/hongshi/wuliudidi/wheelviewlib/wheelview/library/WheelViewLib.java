...
import com.hongshi.wuliudidi.wheelviewlib.wheelview.library.adapter.WheelViewAdapter;
 ...
 */
public class WheelViewLib extends View {
...
//			0x00ffffff, 0x77ffffff };
	 ...
	 * Constructor
	 */
	public WheelViewLib(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelViewLib(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelViewLib(Context context) {
		super(context);
		initData(context);
	}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.wheel_province_line_border));
		// 设置线宽
...
//			itemsLayout.setBackgroundResource(R.color.activity_bg_gray);
