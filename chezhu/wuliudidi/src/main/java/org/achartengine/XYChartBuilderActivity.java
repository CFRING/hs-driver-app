...
public class XYChartBuilderActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.xy_chart_activity);
    ...
    myTestButton = (Button) findViewById(R.id.my_test);
    ...
    myTestButton.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
//        Intent intent = new Intent(XYChartBuilderActivity.this, AccountBookActivity.class);
      ...
      mChartView.setOnClickListener(new View.OnClickListener() {
        public void onClick(View v) {
          ...
          if (seriesSelection == null) {
            Toast.makeText(XYChartBuilderActivity.this, "No chart element", Toast.LENGTH_SHORT).show();
          } else {
            // display information of the clicked point
            Toast.makeText(
                XYChartBuilderActivity.this,
