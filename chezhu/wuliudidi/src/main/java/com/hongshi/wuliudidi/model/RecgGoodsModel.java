...
public class RecgGoodsModel implements Serializable {
    ...
    public boolean isSenderCorporation() {
        ...
        public void setSenderCorporation(boolean senderCorporation) {
            this.senderCorporation = senderCorporation;
        }

        public boolean isRecCorporation() {
            return recCorporation;
        }

        public void setRecCorporation(boolean recCorporation) {
            this.recCorporation = recCorporation;
        }
