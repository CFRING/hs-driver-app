...
/**
 * Created by JonneyChan on 30.01.14.
 */
...
// #MARK - Constructors
    ...
    public MagnificentChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            boolean isRound = typedArray.getBoolean(R.styleable.MagnificentChart_round1, false);
...
// #MARK - Drawing Methods
    ...
    private void animatedDraw(Canvas canvas){
        ...
        if(chartItemsList != null && maxValue > 0){
            ...
            globalCurrentAngle += animationSpeed;
...
//            }
            ...
            insideChartPaint.setTextSize(context.getResources().getDimension(R.dimen.width_31));
            insideChartPaint.setTextAlign(Align.CENTER);
            insideChartPaint.setColor(getResources().getColor(R.color.circle_red));
            canvas.drawText(""+total, x, y, insideChartPaint);
            
            insideChartPaint.setAntiAlias(true);
            insideChartPaint.setTextSize(context.getResources().getDimension(R.dimen.width_12));
            insideChartPaint.setTextAlign(Align.CENTER);
            insideChartPaint.setColor(getResources().getColor(R.color.circle_gray));
            canvas.drawText("参与接单人", x, y+context.getResources().getDimension(R.dimen.width_15), insideChartPaint);
