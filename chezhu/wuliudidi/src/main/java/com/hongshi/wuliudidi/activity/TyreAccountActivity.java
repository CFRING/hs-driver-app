...
public class TyreAccountActivity extends Activity implements View.OnClickListener {
    ...
    private BroadcastReceiver mRefreshBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if("com.action.tyre".equals(action)){
                getSummaryData();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tyre_account_title.setTitle("轮胎余额");
            ...
            public void onRefresh(PullToRefreshBase<ListView> refreshView) {
                if (mPullToRefreshListView.isRefreshing()) {
                    if (mPullToRefreshListView.isHeaderShown()){
                        ...
                        // 加载更多
                        if(isEnd){
                            Toast.makeText(TyreAccountActivity.this, "已经是最后一页", Toast.LENGTH_SHORT).show();
        ...
        accountAdapter = new AccountAdapter(TyreAccountActivity.this,accountDetailList);
...
//    private final String account_detail_url = "http://192.168.158.150:8080/gwcz/tradeRecord/list.do?";
    ...
    private void sessionLoadData(final boolean isRefresh){
        ...
        DidiApp.getHttpManager().sessionPost(TyreAccountActivity.this, account_detail_url, params, new ChildAfinalHttpCallBack() {
            @Override
...
//    private final String account_summary_url = "http://192.168.158.150:8080/gwcz/carrier/app/acct/acctInfo.do";
    private void getSummaryData(){
        ...
        DidiApp.getHttpManager().sessionPost(TyreAccountActivity.this, account_summary_url, params, new ChildAfinalHttpCallBack() {

            @Override
            public void onFailure(String errCode, String errMsg, Boolean errSerious) {
                Toast.makeText(TyreAccountActivity.this,errMsg,Toast.LENGTH_LONG).show();
            }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.scan_payment:
                ...
                scannerIntent.putExtra("from","tyre_activity");
            ...
            case R.id.time_shift_detail:
                Intent intent = new Intent(TyreAccountActivity.this,FilterActivity.class);
                intent.putExtra("account_value",3);
